...
public class ReadArticle {
   public static void readArticle(Scanner scanner, Article article, String currentUser) {
       while (true) {
           ...
           List<Comment> comments = CommentManager.loadComments(article.getId(),article.getTimes().TimeMilliseconds()+"_" + article.getTitle());
           if (comments.isEmpty()) {
           ...
           if (command.equals("0")) {
               ...
               article.like();
               ArticleManagement.saveArticle(article);
               ...
               CommentManager.addComment(newarticle.getId(), content,newarticle);
               ...
               if (currentUser != null) {
                   if (parts.length == 2) {
                       ...
                       if (commentIndex >= 0 && commentIndex < comments.size()) {
                           ...
                           CommentManager.addreplyComment(newarticle.getId(), comments.get(commentIndex).getId(), currentUser, reply,newarticle);
