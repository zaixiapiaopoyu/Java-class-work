...
public class Comment {
    ...
    public Comment(int id, int articleId, String content, Times times) {
        this.id = id;
    ...
    public String toFileString() {
        return id + "、" + articleId + "、" + content + "、" + times.print();
    }
    ...
    public static Comment fromString(String line) {
        try {
            ...
            int articleId = Integer.parseInt(parts[1].trim());
            ...
            return new Comment(id, articleId, content,times);
        }
        catch (Exception e) {
